...
public class RandomGenerator {
    ...
    static private String[] facts = {
            ...
            "Regiunea cu cea mai scăzută criminalitate este Quebec, Canada. Rata criminalității în această zonă este similară cu cea înregistrată într-un parc Disney World, aproape ",
            ...
            "Dac transportați o bombă nucleară în orașul Chico din California, sunteți pasibili de amendă pentru transport de material radioactiv pe teritoriul orașului.",
            ...
            "Dacă locuiești în Danemarca și te gândești să-i dai copilului tău un nume ieșit din comun, ar fi bine să consulți regulile oficiale. Dacă numele pe care-l dorești nu se află printre cele 7000 de nume aprobate de autorități, ai nevoie de avizul special al guvernului danez.",
