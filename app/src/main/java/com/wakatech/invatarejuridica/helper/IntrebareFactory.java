...
public class IntrebareFactory {
    ...
    private void loadLevel5()
    {
        ...
        question[7] = new Intrebare("CCe trebuie să facă victima unei situații de bullying? ","Nimic, se lasă intimidată, poate agresorul încetează ","Anunță profesorul, părinții, pe cei apropiați, sau chiar depune plângere la poliție ","Răspunde cu un comportament la fel de violent, ostil și umilitor ",0,1,0);
    ...
    private void loadLevel6()
    {
        ...
        question[11] = new Intrebare("Minorul dobândește, prin căsătorie: ","Capacitate deplină de exercițiu ","Capacitate lărgită de exercițiu ","Incapacitate de exercițiu ",1,0,0);
        ...
        question[9] = new Intrebare("Are dreptul la libertate de exprimare: ","Orice persoană ","Persoanele care sunt membre ale unor asociații ","Nicio persoană nu are dreptul la libertate de exprimare ",1,0,0);
        question[10] = new Intrebare("Reprezintă o atingere a vieții private: ","Interceptarea fără drept a unei convorbiri private ","Interceptarea autorizată a unei convorbiri private ","Interceptarea nu este legală ",1,0,0);
    ...
    {
        question[0] = new Intrebare("Moștenirea este: ","O formă de recunoștință față de cel decedat ","O formă de transmitere a bunurilor de la persoana decedată către moștenitorii acestuia ","Drepturile și obligațiile dobândite de către o persoană la momentul nașterii ",0,1,1);
    ...
    private void loadLevel16()
    {
        ...
        question[8] = new Intrebare("În Țările Române, corupţia a fost la cel mai înalt nivel, în: ","Perioada fanariota ","Perioada interbelica ","Perioada domniei lui Nicolae Alexandru ",1,0,0);
    ...
    private void loadLevel18()
    {
        ...
        question[5] = new Intrebare("Reprezintă forma agravată a infracțiunii de „lovire și alte violențe”, fapta prin care se produc leziuni traumatice sau este afectată sănătatea unei persoane, a cărei gravitate este evaluată prin zile de îngrijiri medicale de cel mult:  ","a) 60 de zile ","b) 30 de zile ","c) 90 de zile ",0,0,1);
        question[6] = new Intrebare("Lipsirea de libertate a  unei persoane este mai gravă când este săvârșită: ","a) Sub influența băuturilor alcoolice ","b) Asupra unui minor ","c) De către o persoană mascată ",0,1,0);
        question[7] = new Intrebare("Fapta celui care, în mod repetat, urmărește, fără drept sau fără un interes legitim, o persoană ori îi supraveghează locuința, locul de muncă sau alte locuri frecventate de către aceasta, cauzându-i astfel o stare de temere reprezintă infracțiunea de: ","a) Șantaj ","b) Hărțuire ","c) Amenințare ",0,1,0);
        question[8] = new Intrebare("Refuzul de a părăsi locuința, încăperea, dependința sau un loc împrejmuit ținând de acestea, la cererea persoanei care le folosește, reprezintă: ","a) Lipsă de respect ","b) Violare de domiciliu ","c) Violarea vieții private ",0,1,0);
        question[9] = new Intrebare("Luarea unui bun mobil, chiar dacă bunul aparține în întregime sau în parte făptuitorului, dar în momentul săvârșirii acel bun se găsea în posesia altei persoane care nu si-a dat consimțământul, reprezintă: ","a) Furt din amuzament ","b) Tulburare de posesie ","c) Furt ",0,0,1);
