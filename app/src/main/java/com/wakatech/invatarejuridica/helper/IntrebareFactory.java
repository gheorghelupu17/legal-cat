...
public class IntrebareFactory {
    ...
    private void loadLevel3() {
        ...
        question[2] = new Intrebare("Minorii:  ", "Pot fi angajați ca salariați indiferent de vârstă ", "Pot fi angajați ca salariați cel mai devreme la împlinirea vârstei de 15 ani ", "Nu pot fi angajați ca salariați niciodată", 0, 1, 0);
    ...
    {
        question[0] = new Intrebare("Care sunt instanțele (instituțiile) judecătorești din România? ","Înalta Curte de Casație și Justiție, Curțile de Apel, Tribunalele, Judecătoriile ","Parchetele ","Parlamentul ",1,0,0);
    ...
    private void loadLevel7()
    {
        ...
        question[4] = new Intrebare("Schimbarea numelui unui cetățean român este posibilă:  ","La cererea oricărei persoane, interesate sau nu","La cererea persoanei interesate, în condițiile legii ","La cererea judecătorului ",0,1,0);
    ...
    private void loadLevel8()
    {
        ...
        question[1] = new Intrebare("Părinții au îndatorirea/obligația de a crește copilul în condiții care să îi asigure: ","În principal dezvoltarea fizică a copilului ","Dezvoltarea fizică, mentală, spirituală, morală și socială a copilului ","Confort material  ",0,1,0);
        question[2] = new Intrebare("Măsurile disciplinare care pot fi luate de părinți față de copii trebuie: ","Să respecte demnitatea copilului ","Să urmărească stabilirea fricii ","Să îi oblige pe aceștia să asculte, indiferent de felul măsurii ",1,0,0);
        question[3] = new Intrebare("Ziua mondială a drepturilor copilului este marcată pe data de: ","1 ianuarie ","20 noiembrie ","1 iulie ",0,1,0);
    ...
    private void loadLevel9()
    {
        ...
        question[5] = new Intrebare("Ca excepție, căsătoria se poate încheia la împlinirea vârstei de: ","14 ani ","16 ani, cu dispensă din partea autorității tutelare ","Oricând ",0,1,0);
    ...
    private void loadLevel11()
    {
        ...
        question[3] = new Intrebare("Părinții au obligația de a întreține copiii până: ","La vârsta de 16 ani ","Până la momentul căsătoriei  acestora ","Până la finalizarea studiilor acestora, dar fără a depăși vârsta de 26 ani ",0,0,1);
    ...
    private void loadLevel13()
    {
        ...
        question[2] = new Intrebare("Până când își exercită Guvernul mandatul? ","Guvernul își exercită mandatul până la data validării alegerilor parlamentare unice  ","Guvernul își exercită mandatul până la data validării alegerilor parlamentare generale, dar și în anumite situații prevăzute de Constituție ","Guvernul își exercită mandatul până la data validării alegerilor teritoriale ",0,1,0);
    ...
    private void loadLevel14()
    {
        ...
        question[1] = new Intrebare("Autoritatea publică are obligația: ","Să comunice petiționarului un răspuns în termen de  30 de zile de la data înregistrării petiției","Nu are nicio obligație ","Să comunice petiționarului un răspuns atunci când are chef și timp ",1,0,0);
    ...
    private void loadLevel17()
    {
        ...
        question[10] = new Intrebare("Fapta este săvârșită cu intenție când făptuitorul:","Prevede rezultatul faptei sale, urmărind sau acceptând producerea lui prin săvârșirea acelei fapte","Nu acceptă producerea rezultatului","Nu prevede rezultatul faptei sale",1,0,0);
        question[11] = new Intrebare("Tentativa constă în punerea în executare a intenției de a săvârși infracțiunea, executare care a fost însă:","Suspendată din voinţa fătuitorului","Dusă la bun sfârşit, dar nu şi-a produs efectul","Amânată pentru un moment ulterior",0,1,0);
        question[12] = new Intrebare("Nu se pedepsește autorul care, înainte de descoperirea faptei:","A încunoștințat autoritățile de comiterea acesteia, chiar dacă infracţiunea s-a consumat","Reuşeşte să părăsească teritoriul ţării","Împiedică el însuşi consumarea infracţiunii",0,0,1);
        question[13] = new Intrebare("Există recidivă când:","După rămânerea nedefinitivă a unei hotărâri de condamnare condamnatul săvârșește din nou o infracțiune, pentru care legea prevede pedeapsa amenzii","După rămânerea definitivă a unei hotărâri de condamnare la pedeapsa închisorii mai mare de un an și până la reabilitare sau împlinirea termenului de reabilitare, condamnatul săvârșește din nou o infracțiune (cu intenție sau cu intenție depășită), pentru care legea prevede pedeapsa închisorii de un an sau mai mare","După rămânerea nedefinitivă a unei hotărâri de condamnare condamnatul săvârșește din nou o infracțiune, pentru care legea nu prevede o pedeapsă",0,1,0);
        question[14] = new Intrebare("Complice este persoana care:","Cunoaşte despre săvârşirea unei infracţiuni, dar nu o denunţă","Ajută infractorul să scape de tragerea la răspundere penală","Înlesnește sau ajută cu intenție şi în orice mod la săvârșirea unei fapte prevăzute de legea penală",0,0,1);
        question[15] = new Intrebare("Următoarele împrejurări constituie circumstanțe atenuante legale:","Eforturile depuse de infractor pentru înlăturarea sau diminuarea consecințelor infracțiunii","Lipsa antecedentelor penale pentru infractor","Săvârșirea infracțiunii sub stăpânirea unei puternice tulburări sau emoții, determinată de o provocare din partea persoanei vătămate, produsă prin violență, printr-o atingere gravă a demnității persoanei sau printr-o altă acțiune ilicită gravă",0,0,1);
    ...
    private void loadLevel18()
    {
        ...
        question[10] = new Intrebare("Nedenunțarea săvârșită de un membru de familie: "," Nu se pedepsește "," Este cauză justificativă"," Este cauză de neimputabilitate ",1,0,0);
        question[11] = new Intrebare("Întrebuințarea de expresii jignitoare față de o persoană, de către cel aflat în exercitarea atribuțiilor de serviciu, reprezintă infracțiunea de:"," Neglijență în serviciu"," Abuz în serviciu","Purtare abuzivă",0,0,1);
        question[12] = new Intrebare("Constituie infracțiunea de falsificare de monedă:","Chiar dacă moneda nu are valoare circulatorie"," Dacă aceasta a fost emisă de către autoritățile competente,  chiar și înainte de punerea oficială în circulație","Inclusiv falsificarea de titluri de credit",0,1,0);
        question[13] = new Intrebare("Legea penală:","Se aplică infracțiunilor săvârșite în timpul cât ea se află în vigoare","Legea penală nouă se aplică şi faptelor săvârșite sub legea veche","Legea penală temporară se aplică infracțiunii săvârșite în timpul când era în vigoare, numai dacă fapta a fost urmărită sau judecată în acel interval de timp",1,0,0);
        question[14] = new Intrebare("Infracțiunea este fapta prevăzută de legea penală, săvârșită cu vinovăție, …… şi imputabilă persoanei care a săvârșit-o. Cuvântul care lipseşte este:","Intenţionată","Intenţionată sau din culpă","Nejustificată",0,0,1);
