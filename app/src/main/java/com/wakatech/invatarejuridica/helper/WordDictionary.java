...
public class WordDictionary {
    ...
    private HashMap<String,String> createMap() {
        ...
        map.put("A concesioná (bunuri materiale) "," a da în concesiune; a pune la dispoziție printr-un act oficial");
        ...
        map.put("Cumparare de influență "," a intra în posesia unui lucru plătind, a mitui, a corupe.");
        ...
        map.put("Hotarare/sentinta judecatoreasca "," hotărâre, decizie a unui tribunal, pronunțată în primă instanță.");
        ...
        map.put("Pedepsele privative de libertate "," sancțiuni care se prezintă sub două forme de pedepse: detenţiunea pe viaţă  și închisoarea de la 15 zile la 30 de ani.");
        map.put("Măsurile educative neprivative de libertate "," sunt sancţiuni de drept penal care se aplică minorilor care au comis o infracţiune a cărei gravitate nu necesită privarea de libertate. Acestea sunt: stagiul de formare civică, supravegherea, consemnarea la sfârşit de săptămână şi asistarea zilnică.");
        ...
        map.put("Impozitul "," prelevare obligatorie și gratuită, efectuată de către stat asupra resurselor sau bunurilor individuale sau ale colectivităților și plătită în bani.");
        map.put("Taxa "," acele obligații bănești pe care trebuie să le achite persoanele fizice și juridice pentru diferite prestații efectuate de autoritățile publice și constă în sumele de bani prevăzute de hotărâri sau ordonanțe guvernamentale.");
        ...
        map.put("Contributie  "," parte cu care cineva participă la o acțiune sau la o cheltuială comună.");
        map.put("Persoana fizica "," orice om care ia fiinta inca de la nastere si care participa la relatiile sociale prin faptele sale, avand drepturi si obligatii in societate.");
        map.put("Persoana juridica "," ia nastere prin vointa omului, constituindu-se prin contract intr-o societate ce capata personalitate juridica in urma inregistrarii.");
        map.put("Buna credinta "," convingere intimă a unei persoane că ceea ce face este bine, conform legii.");
        ...
        map.put("Tutela "," în cazul in care ambii parinti sunt morti, necunoscuti, decazuti din drepturile parintesti, pusi sub interdictie, disparuti ori declarati morti și copilul este lipsit de ingrijirea ambilor parinti, copilul este pus sub tutela.");
        map.put("Instanta de tutela "," instanta care stabileste  si are in grija tutela.");
        ...
        map.put("Administratie "," totalitatea organelor administrative ale unui stat.");
