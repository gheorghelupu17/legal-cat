...
public class WordDictionary {
    ...
    private HashMap<String,String> createMap() {
        ...
        map.put("Constituția","lege fundamentală a unui stat, învestită cu o forță juridică superioară celorlalte legi, prin care sunt fixate modalitățile de încredințare și de exercitare a puterii, drepturile și îndatoririle cetățenilor, constituirea și funcționarea organelor centrale și locale de stat, raporturile dintre ele sau raporturile acestora cu cetățenii etc.");
        ...
        map.put("Taxă","acea obligație bănești pe care trebuie să le achite persoanele fizice și juridice pentru diferite prestații efectuate de autoritățile publice și constă în sumele de bani prevăzute de hotărâri sau ordonanțe guvernamentale.");
        map.put("Taxe","acele obligații bănești pe care trebuie să le achite persoanele fizice și juridice pentru diferite prestații efectuate de autoritățile publice și constă în sumele de bani prevăzute de hotărâri sau ordonanțe guvernamentale.");
        ...
        map.put("Persoană fizică","orice om care ia ființa încă de la naștere și care participă la relatiile sociale prin faptele sale, avand drepturi și obligații în societate.");
        ...
        map.put("Instanței de tutelă","instanta care stabileste  si are in grija tutela.");
        ...
        map.put("Apatrizi","persoane care au pierdut calitatea de cetățeni ai patriei lor (părăsind-o în mod ilegal) și n-au dobândit nici cetățenia țării în care s-au stabilit. Oameni fără patrie.");
        ...
        map.put("Interdicție judecătorească","ansamblul măsurilor prevăzute expres de lege, care se iau de către instanță pentru ocrotirea persoanelor fizice lipsite de discernământul necesar pentru a se îngriji de interesele lor.");
        map.put("Defunct","(persoană) care a decedat. ");
        map.put("DISCERNĂMÂNT","Facultatea de a discerne, de a pătrunde, de a judeca și a aprecia lucrurile la justa lor valoare.");
        ...
        map.put("Hotărâri judecătorești","hotărâri, decizii a unui tribunal, pronunțate în primă instanță.");
        ...
        map.put("Act de înstrăinare","act juridic prin care titularul unui drept real asupra unui lucru sau al unui drept de creanță transmite, cu orice titlu, acel drept altei persoane.");
        map.put("Acte de înstrăinare","acte juridice prin care titularul unui drept real asupra unui lucru sau al unui drept de creanță transmite, cu orice titlu, acel drept altei persoane.");
        map.put("Petru cel Mare","În istoria Rusiei, cazurile de mită au fost tratate diferit în diverse epoci. Pe timpul împărătesei Ecaterina a II-a, numele mituitorului era afișat în piața publică. Sub Petru cel Mare, în schimb, mita era tratată drept crimă, iar făptuitorul putea fi spânzurat sau deportat în Siberia.");
        map.put("Matei Basarab","Iniţiatorul primelor legi împotriva fenomenului corupţiei din Ţările Române ar fi fost Matei Basarab (1580 – 1654). În anul 1632, el emite o Pravilă ( n. red. precursoarea legii în formă actuală ) în care specifică foarte clar că luarea de mită sau orice altă formă de corupţie era aspru pedepsită. Fără să aibă un sistem al pedepselor bine stabilit, totul depindea de învoiala domnitorului sau a judecătorului care, de cele mai multe ori, avea un rol decorativ. Dacă furia domnitorului faţă de corupt era mare sau dacă fapta era destul de gravă, pedepsitul putea fi schingiuit sau bătut până îşi dădea obştescul sfârşit.");
        map.put("Constantin Hangerli","În cazul domnitorilor corupţi, de cele mai multe ori se aplica pedeapsa cu moartea. I s-a întâmplat domnitorului fanariot al Ţării Româneşti, Constantin Hangerli.   El a reuşit să inventeze un sistem propriu de colectare a dărilor şi birurilor, banii ajungând în propriile sale buzunare. Evident toate sumele erau colectate de la ţăranii şi boierii Ţării Româneşti care, văzând cum se petrec lucrurile, au somat Înalta Poartă. Furia sultanului a fost atât de mare încât acesta a ordonat ca domnitorul Hangerli să fie omorât prin decapitare.");
        ...
        map.put("Capacitate deplină de exercițiu","începe la data când persoana devine majoră, adică la împlinirea vârstei de 18 ani.");
        map.put("Capacitate de exercițiu","este aptitudinea persoanei de a încheia singură acte juridice civile.");
        map.put("Capacitate de exercițiu anticipată","pentru motive temeinice, instanța de tutelă poate recunoaște minorului care a împlinit vârsta de 16 ani capacitatea deplină de exercițiu. ");
        map.put("Capacitate de exercițiu restransă","minorul care a împlinit vârsta de 14 ani are capacitatea de exercițiu restransă.");
        map.put("Curator","persoană care exercită drepturile și execută obligațiile decurgând din curatelă.");
        map.put("Măsuri educative","sancţiuni ce se aplică minorului care a săvârşit o faptă prevăzută de legea penală: mustrarea, libertatea sub supraveghere, internarea într-un centru de reeducare şi internarea într-un institut medical educativ.");
